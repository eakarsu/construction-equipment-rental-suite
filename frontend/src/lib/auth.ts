export const AUTH_COOKIE = 'construction_equipment_rental_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@construction-equipment-rental.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@construction-equipment-rental.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@construction-equipment-rental.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
