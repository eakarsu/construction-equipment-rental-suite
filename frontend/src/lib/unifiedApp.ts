...
const features = [
  {
    ...
    summary: 'Customers workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Commerce',
    icon: Users,
    summary: 'Orders workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Commerce',
    icon: ClipboardList,
    summary: 'Catalog workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Commerce',
    icon: CalendarCheck,
    summary: 'Inventory workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Pricing workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Promotions workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Fulfillment workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Returns workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Exceptions workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Reviews workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Construction Equipment Rental suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Construction Equipment Rental documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Construction Equipment Rental alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Construction Equipment Rental source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Construction Equipment Rental users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Construction Equipment Rental assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIConstructionEquipmentRentalAssistant', 'AIConstructionEquipmentRentalOperations where applicable'],
