...
export const sourceSystems = [
  { name: 'AIConstructionEquipmentRentalAssistant', ownership: 'Customers source capabilities and workflows', coverage: ['Customers', 'Orders', 'Catalog'] },
  { name: 'AIConstructionEquipmentRentalOperations', ownership: 'Orders source capabilities and workflows', coverage: ['Inventory', 'Pricing', 'Promotions'] },
  { name: 'AIConstructionEquipmentRentalAnalytics', ownership: 'Catalog source capabilities and workflows', coverage: ['Fulfillment', 'Returns', 'Exceptions'] },
  { name: 'AIConstructionEquipmentRentalWorkflow', ownership: 'Inventory source capabilities and workflows', coverage: ['Reviews', 'Analytics', 'Reports'] },
];
