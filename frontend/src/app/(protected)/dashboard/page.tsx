...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Construction Equipment Rental Dashboard"
      subtitle="One merged construction equipment rental view for Customers, Orders, Catalog, Inventory, Pricing, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared construction equipment rental jobs into one surface. Customers, Orders, Catalog, Inventory, Pricing, Promotions, documents, audit, and AI are presented as platform features.</div>
