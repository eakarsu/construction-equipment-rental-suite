...
PORT="${PORT:-5690}"
DB_NAME="${PGDATABASE:-construction_equipment_rental_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Construction Equipment Rental Suite"
echo "======================================="
echo
...
echo "Starting construction equipment rental suite frontend on http://localhost:$PORT"
echo "Login: admin@construction-equipment-rental.local / admin123"
